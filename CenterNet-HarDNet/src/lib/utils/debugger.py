...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    #elif num_classes == 15 or dataset == 'coco':
  ...
  def save_all_imgs(self, path='./cache/debug/', prefix='', genID=False):
    ...
    for i, v in self.imgs.items():
      cv2.imwrite(path + '/{}_{}.png'.format(str(i).zfill(4), prefix), v)
...
coco_class_name = ['__background__', 'HDMI']
#coco_class_name = [
#  '__background__', 'HDMI', 'USB_Mini', 'Dock', 'Lightning', 'USB_Micro_B',
#  'Mini_DisplayPort', 'RJ_45', 'USB_Type_A', 'USB_Type_C', 'USB_Micro_B_3.1',
#  'USB_Type_B', 'Lightning_T', 'USB_Micro_B_W', 'VGA', 'DisplayPort'
#]
